...
module.exports = function umlPlugin (md, options) {
  ...
  function uml (state, startLine, endLine, silent) {
    ...
    var imgSrc = generateSource(contents, options)
    token.attrs = [
      ['src', loadingSrc],
