      ...
      menus['status-bar-insert']?.list?.push(
        {
          ...
          subTitle: ctx.action.getKeysLabel([ctx.action.Keys.Alt, 'i']),
        ...
        },
        {
          ...
          subTitle: ctx.action.getKeysLabel([ctx.action.Keys.Alt, 'f']),
        ...
        },
        {
          ...
          subTitle: ctx.action.getKeysLabel([ctx.action.Keys.Alt, 'd']),
        ...
        },
        {
          ...
          subTitle: ctx.action.getKeysLabel([ctx.action.Keys.Alt, ctx.action.Keys.Shift, 'f']),
          onClick: () => linkFile(),
        },
        { type: 'separator' },
      )
